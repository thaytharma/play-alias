...
describe('Word', () => {
  it('shows a word for the selected language', () => {
    render(<Word language={Language.EN} mode="default" level="medium" isTimeUp={false} onWordChange={vi.fn()} />);
  ...
  it('calls onWordChange when the word is clicked', async () => {
    ...
    render(<Word language={Language.EN} mode="default" level="medium" isTimeUp={false} onWordChange={onWordChange} />);
  ...
  it('shows the brand instead of the word when time is up', () => {
    render(<Word language={Language.EN} mode="default" level="medium" isTimeUp onWordChange={vi.fn()} />);
  ...
  it('stores shown words and resets the history on reset', async () => {
    ...
    render(
      <Word ref={ref} language={Language.EN} mode="default" level="medium" isTimeUp={false} onWordChange={vi.fn()} />,
    );
